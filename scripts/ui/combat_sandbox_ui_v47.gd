extends "res://scripts/ui/main_v50_ge01.gd"
...
func _fr_state(value: String) -> String:
    return str({
        ...
        "impaired":"diminuée", "stabilized":"stabilisée", "functional":"fonctionnelle",
        "injured":"lésé", "weak":"faible", "strong":"forte", "unknown":"inconnu"
    }.get(value, value))

...
##
## The backing implementation is currently the v0.9 vertical-slice runtime. New
## production code should depend on this neutral singleton rather than a versioned
## runtime or any VS001 symbol.

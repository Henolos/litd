...
def test_collects_exact_pr_head_and_runs(get):
    get.side_effect=[{"number":438,"state":"open","merged":False,"head":{"sha":"a"*40},"updated_at":"2026-09-20T00:00:00Z"},{"workflow_runs":[{"id":1,"name":"CI","status":"completed","conclusion":"success"}]}]
...
def test_collector_does_not_invent_evidence(get):
    get.side_effect=[{"number":1,"state":"closed","merged":True,"head":{"sha":"b"*40},"updated_at":"now"},{"workflow_runs":[]}]
